...
"test-0004" is for testing table extraction in [PDFProdigy](http://www.pdfprodigy.com) with a very simple table with all the borders, headers and with some spanning cells.
